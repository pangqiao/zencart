 ...
 */
    $content = "";
	$content .= '<div id="currency_header" class="topBox">';
    $content .= zen_draw_form('currencies_form_header', zen_href_link(basename(ereg_replace('.php','', $PHP_SELF)), '', $request_type, false), 'get');
