...
<!--eof Attributes Module -->
	...
	<?php
	/**
	 * display the products quantity discount       qiaowei
	 */
	...
	<!--eof Quantity Discounts table -->
			...
			?>
				...
				$display_qty_q = PRODUCTS_ORDER_QTY_TEXT . '<select name="cart_quantity" class="PriceDrop">'. $optvalues .'</select><br />' 
				    . zen_get_products_quantity_min_units_display((int)$_GET['products_id']) . '<br />' ;
...
<!--eof Product details list qiaowei 
 <div id="askQuestion" class="biggerText">
   <?php echo '<a href="' . zen_href_link(FILENAME_ASK_A_QUESTION, 'products_id='
   . $_GET['products_id']) . '">' .
   zen_image_button('button_ask_question.gif', BUTTON_ASK_A_QUESTION_ALT) .
   '</a>'; ?></div>
   <br />
   <br class="clearBoth" />
 ...
 */
 //GPE模块 原文件修改开始  ；原来是在属性部分显示的那几张大图！！
 if(GPE_MODULE_GPE_SWITCH == 'false') {
