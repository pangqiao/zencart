...
<div  class="left_cp">
	<?php if(GPE_MODULE_GPE_SWITCH == 'true') { ?>
		<?php
			$mainImg = '<a id="jqzoom" href="images/'.$products_image.'" title="'.$products_name.'">' . zen_image($products_image_medium, $products_name, 340, 0) . '</a>';//MEDIUM_IMAGE_WIDTH, MEDIUM_IMAGE_HEIGHT
