...
<?php
  ...
  //column_layout_grid_2_3_1 & product_listing_sorter_2.0 added by Qiao Wei. keeep it since no bug seen.
...
<?php
  ...
  if ($do_filter_list) {
    echo zen_draw_pull_down_menu('filter_id', $options, (isset($_GET['filter_id']) ? $_GET['filter_id'] : ''), 'onchange="this.form.submit()" class="subcatogory"');
  }
