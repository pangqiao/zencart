...
<div id="productAttributes">
		...
		<?php
		/*<h3 id="attribsOptionsText"><?php echo TEXT_PRODUCT_OPTIONS; ?></h3>**deletec by QiaoWei content: Please Choose*/
		?>
	...
	<?php
		for($i=0;$i<sizeof($options_name);$i++) {
					...
					?>
							...
							<?php
							/**
							 * attributesComments does not show in website.
							 http://localhost/big-linked-c-22/a-bugs-life-multi-pak-special-2003-collectors-edition-p-34.html
							 attibutesComments:gift options.
							 added by QiaoWei
							 */
							?>
					<?php
