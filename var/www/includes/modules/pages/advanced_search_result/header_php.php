...
//================================ Begin of Advanced Search Plus
   $found_products_ad = false;
} else  {
   $found_products_ad = true;
}
$found_categories = false;
require(DIR_WS_MODULES . zen_get_module_directory('advanced_search_categories.php'));
$found_ezpages = false;
require(DIR_WS_MODULES . zen_get_module_directory('advanced_search_ezpages.php'));
if (($found_products_ad == false) && ($found_categories == false) && ($found_ezpages == false))  {  
//   $messageStack->add_session('search', TEXT_NO_PRODUCTS, 'caution');
   $messageStack->add_session('search', TEXT_NOTHING_FOUND, 'caution');  //Changed with Advanced Search Plus
