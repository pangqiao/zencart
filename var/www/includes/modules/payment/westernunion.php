...
// disable the module if the order only contains virtual products
    ...
    function install() {
     ...
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('City, State, Zip Code', 'MODULE_PAYMENT_WESTERNUNION_CITYSTATEZIP', 'City, State, Zip Code', 'Enter the City, State, Zip Code', '6', '1', now());");
