...
'<font color="green"><hr /><strong>Requirements:</strong></font><br /><hr />*<strong>Express Checkout</strong> must be installed and activated in order to use PayPal Payments Pro, according to PayPal Terms of Service. <br />*Also requires CURL over SSL for outbound communications. CURL should be enabled for ports 80 and 443.<hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_DESCRIPTION', '信用卡');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_TITLE', '信用卡');
  define('MODULE_PAYMENT_PAYPALDP_DP_TEXT_TYPE', '信用卡(WPP)');
  define('MODULE_PAYMENT_PAYPALDP_PF_TEXT_TYPE', '信用卡(PF)');
  define('MODULE_PAYMENT_PAYPALDP_ERROR_HEADING', '对不起，无法处理您的信用卡。');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CARD_ERROR', '您输入的信用卡信息有误，请核定后重试。');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_FIRSTNAME', '持卡人名字:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_LASTNAME', '持卡人姓氏:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_OWNER', '持卡人名字:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_TYPE', '信用卡类型:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_NUMBER', '信用卡号码:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_EXPIRES', '信用卡有效期:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_ISSUE', '信用卡发行日:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_MAESTRO_ISSUENUMBER', '发行号:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_CHECKNUMBER', 'CVV 码:');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_CHECKNUMBER_LOCATION', '(信用卡背面)');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_TRANSACTION_FOR', '交易');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_DECLINED', '您的信用卡被拒，请用另一张卡试试或联系您的银行。');
