...
'<font color="green"><hr /><strong>Requirements:</strong></font><br /><hr />*<strong>CURL</strong> is used for outbound communication with the gateway over ports 80 and 443, so must be active on your hosting server and able to use SSL.<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_TITLE', '信用卡');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_EC_TEXT_TYPE', 'PayPal快速结帐');
  define('MODULE_PAYMENT_PAYPALWPP_DP_TEXT_TYPE', 'PayPal直接支付');
  define('MODULE_PAYMENT_PAYPALWPP_PF_TEXT_TYPE', '信用卡');  //(used for payflow transactions)
  ...
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_TXT', '通过PayPal付款，安全而且简单。');
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_BUTTON_ALTTEXT', '点这里使用PayPal快速结帐');
