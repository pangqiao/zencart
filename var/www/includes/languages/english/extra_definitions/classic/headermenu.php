...
define('HEADER_TITLE_ADDRESS_BOOK','Address Book');
define('HEADER_TITLE_ACCOUNT_HISTORY','Order History');
define('HEADER_TITLE_NEWSLETTERS','Newsletter Subscriptions');
...
/*bof connect with us icons*/
define('FACEBOOK_ICON_SM', 'facebook_sm.png');
define('TWITTER_ICON_SM', 'twitter_sm.png');
define('YOUTUBE_ICON_SM', 'youtube_sm.png');
define('PINTEREST_ICON_SM', 'pinterest_sm.png');
define('GOOGLE_ICON_SM', 'google_sm.png');
define('BLOG_ICON_SM', 'blog_sm.png');

/*bof connect with us text definitions*/
define('FACEBOOK_TEXT', 'Facebook');
define('TWITTER_TEXT', 'Twitter');
define('YOUTUBE_TEXT', 'Youtube');
define('PINTEREST_TEXT', 'Pinterest');
define('GOOGLE_TEXT', ' Google+');
define('BLOG_TEXT', 'My Blog');
