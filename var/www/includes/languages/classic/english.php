...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a> | <a href="http://www.turpyonlinesolutions.com">Zen Cart Template</a> by Turpy Online Solutions');
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT','Qty : ');
...
// extra product listing sorter
  ...
  define('TEXT_PRODUCTS_LISTING_ALPHA_SORTER_NAMES', 'Alphabet');
