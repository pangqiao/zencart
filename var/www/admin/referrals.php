  ...
  if (zen_not_null($action)) {
    switch ($action) {
      ...
      case 'save':
        ...
        break;
      case 'deleteconfirm':
        $sources_id = zen_db_prepare_input($_POST['sID']);
...
<?php
  ...
  switch ($action) {
    ...
    case 'delete':
      ...
      $contents = array('form' => zen_draw_form('sources', FILENAME_REFERRALS, 'page=' . $_GET['page'] . '&action=deleteconfirm', 'post'));
      $contents[] = array('text' => TEXT_DELETE_INTRO . zen_draw_hidden_field('sID', $cInfo->sources_id));
