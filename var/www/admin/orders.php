...
<!-- END - Add Super Orders Order Icon -->
              ...
              <tr>
<td class="main"><b><?php echo TEXT_ENTERED_REFERRAL;?></b></td>
<td class="main">
<?php
//rmh referral start
$cust_id_query = "select customers_id from " . TABLE_ORDERS . " where orders_id = '" . (int)$oID . "'";
$cust_result = $db->Execute($cust_id_query);
$cID = $cust_result->fields['customers_id'];
$source_query = "select customers_info_source_id from " . TABLE_CUSTOMERS_INFO . " where customers_info_id = '" . (int)$cID . "'";
$source = $db->Execute($source_query);

$entry_referral = zen_get_sources_name($source->fields['customers_info_source_id'], $cust_result->fields['customers_id']);
echo $entry_referral;
//rmh referral end
?>
</td>
