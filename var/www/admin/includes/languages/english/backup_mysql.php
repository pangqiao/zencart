...
define('LOCAL_EXE_MYSQL',     'D:/wamp/bin/mysql/mysql5.5.20/bin/mysql.exe');  // used for restores
define('LOCAL_EXE_MYSQLDUMP', 'D:/wamp/bin/mysql/mysql5.5.20/bin/mysqldump.exe');  // used for backups
