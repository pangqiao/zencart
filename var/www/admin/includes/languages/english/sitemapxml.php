...
define('TEXT_CONFIGURATION_TITLE_SITEMAPXML_CHECK_DUBLICATES', 'Check Dublicates');
define('TEXT_CONFIGURATION_DESCRIPTION_SITEMAPXML_CHECK_DUBLICATES', 'true - check dublicates,<br />mysql - check dublicates using mySQL (used to store a large number of products),<br />false - don\'t check dublicates');
