 ...
 * @version $Id: sitemapxml.php, v 3.2.10 22.04.2013 8:15 AndrewBerezin $
 */
...
define('TEXT_CONFIGURATION_TITLE_SITEMAPXML_CHECK_DUBLICATES', 'Проверять дубли адресов');
define('TEXT_CONFIGURATION_DESCRIPTION_SITEMAPXML_CHECK_DUBLICATES', 'true - проверять дубли,<br />mysql - исользовать базу данных для проверки адресов (используется для магазинов с большим количеством товаров),<br />false - не проверять дубли');
