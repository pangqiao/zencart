<?php
/*
        MySQL DB backup class for PHP5, version 1.1.0
        written by Luis Arturo Aguilar Mendoza <minibikec@prodigy.net.mx>
        Released under GNU Public license

        Based on MySQL database backup class Version 1.0.1, written by Vagharshak Tozalakyan <vagh@armdex.com>
        and Luis Arturo Aguilar Mendoza <minibikec@prodigy.net.mx>

        Adapted for Zen Cart 1.5 by Skip Water <skip@ccssinc.net> 04.27.2012
*/
...
/**
 * MySQL_DB_Backup allows you to export a database in a web page and download it
 * or save it as a text or compressed file.
 * 
 * @author gerard
 *
 */
class MySQL_DB_Backup
{
	...
	protected function _Retrieve($fp, $compress)
	{
		...
		if ($this->comments)
		{
			...
			$value .= '# ' . MSX_NL;
			$value .= '# Zen Cart v1.5 database' . MSX_NL;
			$value .= '# ' . MSX_NL;
