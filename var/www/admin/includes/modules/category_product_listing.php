...
?>
        ...
        <?php echo '<a href="' . zen_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&pID=' . $products->fields['products_id'] . '&action=change_quantity') . '">' . zen_image(DIR_WS_IMAGES . 'icon_add.png', ICON_CHANGE_QUANTITY) . '</a>'; ?>
