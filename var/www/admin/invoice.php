...
<!-- body_text_eof //-->
<!--BOF admin editable invoice -->
<?php require '../' . (zen_get_file_directory(DIR_WS_LANGUAGES . $_SESSION['language'] . '/html_includes/define_invoice','.php', 'false'));?>
<!--EOF admin editable invoice -->
<br>
</body>
</html>
