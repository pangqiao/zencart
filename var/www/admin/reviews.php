  ...
  if (zen_not_null($action)) {
    switch ($action) {
      ...
      case 'update':
		...
		//bof reply edit
		$reviews_reply_text = zen_db_prepare_input($_POST['reviews_reply_text']);
		//eof reply edit
		...
		//bof reply edit			  
		$db->Execute("update " . TABLE_REVIEWS_DESCRIPTION . "
                      set reviews_reply_text = '" . zen_db_input($reviews_reply_text) . "'
                      where reviews_id = '" . (int)$reviews_id . "'");
		//eof reply edit
...
//Added rd.reviews_reply_text to $reviews below
...
?>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <!--bof reply edit -->
		  <tr>
            <td class="main" valign="top"><b><?php echo ENTRY_REVIEW_REPLY; ?></b><br><br><?php echo zen_draw_textarea_field('reviews_reply_text', 'soft', '70', '15', htmlspecialchars(stripslashes($rInfo->reviews_reply_text), ENT_COMPAT, CHARSET, TRUE)); ?></td>
          </tr>
		  <!--eof reply edit -->
          <tr>
...
<?php
    ...
    if (zen_not_null($_POST)) {
      ...
      $rID = zen_db_prepare_input($_GET['rID']);
//added reviews_reply_text to $reviews
      $reviews = $db->Execute("select r.reviews_id, r.products_id, r.customers_name, r.date_added,
                                      r.last_modified, r.reviews_read, rd.reviews_text, rd.reviews_reply_text,
                                      r.reviews_rating
                               from " . TABLE_REVIEWS . " r, " . TABLE_REVIEWS_DESCRIPTION . " rd
...
?>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <!--bof reply edit -->
		  <tr>
            <td valign="top" class="main"><b><?php echo ENTRY_REVIEW_REPLY; ?></b><br><br><?php echo nl2br(zen_db_output(zen_break_string($rInfo->reviews_reply_text, 15))); ?></td>
          </tr>
		  <!--eof reply edit -->
        </table></td>
      </tr>
